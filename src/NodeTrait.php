...
//        $this->original = array_merge($this->original, $attributes);
    ...
    {
        return NestedSet::POSITION;
    }

    /**
     * Get the user id key name.
     *
     * @return  string
     */
    public function getUserIdName()
    {
        return NestedSet::USER_ID;
    }
    ...
    /**
     * Get the value of the model's position key.
     *
     * @return  bool
     */
    public function getPosition()
    {
        return $this->getAttributeValue($this->getPositionName());
    }

    /**
     * Get the value of the model's user id key.
     *
     * @return  bool
     */
    public function getUserId()
    {
        return $this->getAttributeValue($this->getUserIdName());
    }
